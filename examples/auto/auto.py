...
"""
参考 https://github.com/hpcaitech/ColossalAI/blob/v0.2.5/examples/tutorial/auto_parallel/auto_parallel_with_resnet.py
"""
...
def main():
    ...
    # trace the model with meta data   正常模型，通过元数据追踪计算图
